...
{
    CLLocationCoordinate2D coordinate = [TCDirectionsDataMapper coordinateFromProperties:nil];
...
- (void)testCreateCoordinateFromValidProperties
{
    ...
    CLLocationCoordinate2D coordinate = [TCDirectionsDataMapper coordinateFromProperties:properties];
...
- (void)testCreateCoordinateBoundsFromProperties
{
    ...
    GMSCoordinateBounds *bounds = [TCDirectionsDataMapper coordinateBoundsFromProperties:properties];
...
{
    NSString *boolString = [TCDirectionsDataMapper stringFromBool:YES];
    STAssertEqualObjects(boolString, @"true", @"A BOOL value of YES should return the string \"true\"");
}

- (void)testStringFromBoolNO
{
    NSString *boolString = [TCDirectionsDataMapper stringFromBool:NO];
...
- (void)testStringFromCoordinateValid
{
    ...
    NSString *coordinateString = [TCDirectionsDataMapper stringFromCoordinate:coordinate];    
...
{
    NSString *coordinateString = [TCDirectionsDataMapper stringFromCoordinate:kCLLocationCoordinate2DInvalid];

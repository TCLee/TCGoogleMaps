...
/**
 * A string representing an array of encoded points that represent an 
 * approximate (smoothed) path of the resulting directions.
 * You can use this encoded path as an input parameter to GMSPath
 * pathFromEncodedPath: method.
 *
 * @see GMSPath
 */
@property (nonatomic, copy, readonly) NSString *encodedOverviewPath;
